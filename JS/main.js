...
nombreProducto = prompt("Ingrese el producto que desea comprar:\n1- Si quiere el Producto A (SILLLA PLEGABLE) ingrese = A \n2- Si quiere el Producto B (CAMASTRO) ingrese = B \n3- Si quiere el Producto C (REPOSERA PLEGABLE) ingrese = C").toUpperCase();
